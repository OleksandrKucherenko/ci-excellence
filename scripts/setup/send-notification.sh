...
# CI Pipeline: Send Notifications
# Purpose: Send notifications to configured services using Apprise
# Supports: Slack, Teams, Discord, Telegram, Email, and 90+ other services

NOTIFICATION_TITLE="${1:-CI/CD Pipeline}"
NOTIFICATION_MESSAGE="${2:-Pipeline completed}"
NOTIFICATION_TYPE="${3:-info}"  # info, success, warning, failure
...
FULL_MESSAGE="$TAG <b>${NOTIFICATION_TITLE}</b>
