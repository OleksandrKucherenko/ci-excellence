...
ci:param report "IS_PRERELEASE" "$IS_PRERELEASE"
ci:param report "NPM_RESULT" "$NPM_RESULT"
ci:param report "GITHUB_RESULT" "$GITHUB_RESULT"
ci:param report "DOCKER_RESULT" "$DOCKER_RESULT"
ci:param report "DOCS_RESULT" "$DOCS_RESULT"
